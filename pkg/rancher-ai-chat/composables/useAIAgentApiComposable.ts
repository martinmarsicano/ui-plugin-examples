...
import {
  Agent, AIAgentAPIEvent, Context, HistoryChat, HistoryChatMessage, Message,
  ToolCall,
  ToolsConfig,
} from '../types';
 ...
 * Endpoints:
 *
 * - oauth2: authenticate configured MCP agents
 * - complete/ui-tools: select supported UI tools
