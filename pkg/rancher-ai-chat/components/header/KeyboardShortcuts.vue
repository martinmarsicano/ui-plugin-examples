...
const shortcuts: Shortcut[] = [
  {
    action:               t('aiChat.shortcuts.items.navigateHistory'),
    mac:                  ['↑ ↓'],
    windows:              ['↑ ↓'],
    macSymbolIndexes:     [0],
  ...
  {
    action:           t('aiChat.shortcuts.items.openChat'),
    mac:              ['⌘', ' Shift K'],
    windows:          'Alt K',
    macSymbolIndexes: [0],
  },
  {
    action:           t('aiChat.shortcuts.items.newChat'),
    mac:              ['⌘', ' Shift O'],
    windows:          'Ctrl Shift O',
    macSymbolIndexes: [0],
  },
  {
    action:           t('aiChat.shortcuts.items.copyLastMessage'),
    mac:              ['⌘', ' Shift C'],
    windows:          'Ctrl Shift C',
    macSymbolIndexes: [0],
  },
  {
    action:           t('aiChat.shortcuts.items.toggleHistory'),
    mac:              ['⌘', ' Shift S'],
    windows:          'Ctrl Shift S',
    macSymbolIndexes: [0, 2],
  },
  {
    action:               t('aiChat.shortcuts.items.deleteChat'),
    mac:                  ['⌘', ' Shift ', '⌫'],
    windows:              ['Ctrl Shift ', '⌫'],
    macSymbolIndexes:     [0, 2],
  ...
  <TextLabelPopover ref="popover">
    <div class="shortcuts">
      <div class="shortcuts-section">
        <span class="shortcuts-title">{{ t('aiChat.shortcuts.title') }}</span>
        <div
