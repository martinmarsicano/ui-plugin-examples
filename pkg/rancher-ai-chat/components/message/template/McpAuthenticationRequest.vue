    ...
    >
      <div class="chat-system-mcp-request-request-msg-text">
        ...
        >
          ...
          >
            {{ t('aiChat.agents.selectedAgent.label', { agent: content.agent.displayName }) }}
          </span>
        </div>
      ...
      <div class="chat-system-mcp-request-request-actions">
        <div
          ...
          :data-testid="`rancher-ai-chat-chat-message-confirmation-status-${ props.message.confirmation?.status === ConfirmationStatus.Confirmed ? 'confirmed' : 'canceled'}`"
