      ...
      <div class="chat-welcome-msg-avatar-panel">
        ...
        <div class="chat-welcome-msg-greeting">
          <span class="chat-welcome-msg-greeting-bubble">
            {{ t('aiChat.message.system.welcome.greetings.line3', { name: user.name }, true) }}
          </span>
        </div>
      </div>
      <div class="chat-welcome-msg-text-panel">
        <span>
          {{ t('aiChat.message.system.welcome.greetings.line1', {}, true) }}
        </span>
        <span>
          {{ t('aiChat.message.system.welcome.greetings.line2') }}
        </span>
      </div>
    </div>
    <div
    ...
    >
      <div class="chat-welcome-msg-text">
        <div class="chat-welcome-msg-text-title">
          <span><b>{{ t('aiChat.message.system.welcome.info.label') }}</b></span>
        </div>
        <span
