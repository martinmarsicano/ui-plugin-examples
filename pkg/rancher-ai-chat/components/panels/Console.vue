...
<template>
  <div
    class="chat-console"
    data-testid="rancher-ai-chat-chat-console"
  >
    <div
    ...
    >
      ...
      <textarea
        ...
        rows="1"
        :value="text"
        :placeholder="props.disabled || completeText ? '' : t('aiChat.prompt.placeholder')"
        :disabled="props.disabled"
        autocomplete="off"
        data-testid="rancher-ai-chat-chat-input-textarea"
    ...
    <div
      ...
      data-testid="rancher-ai-chat-chat-console-llm-info"
    >
      <LlmModelLabel
