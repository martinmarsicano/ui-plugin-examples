...
function chatNameTooltip(chat: HistoryChat): string {
  ...
  return t('aiChat.history.chat.items.nameTooltip', {
    name: chat.name,
    createdAt
  }, true);
}
...
<template>
  <transition name="slide-in">
    <div
      ...
      data-testid="rancher-ai-chat-chat-history-panel-overlay"
      @click.self="emit('close:panel')"
    >
      <div
        class="history-panel"
        data-testid="rancher-ai-chat-chat-history-panel"
      >
        ...
        <div class="history-body">
          <RcButton
            ...
            data-testid="rancher-ai-chat-chat-history-create-chat-button"
            @click="createChat"
            @keydown.enter.stop="createChat"
            @keydown.space.enter.stop="createChat"
          >
            <i class="icon icon-plus" />
            <span>{{ t('aiChat.history.chat.create') }}</span>
          </RcButton>
          <div
          ...
          >
            <div class="history-chat-title">
              <span class="history-chat-title-label text-label">
                {{ t('aiChat.history.chat.previous') }}
              </span>
            </div>
            <div class="history-chat-list">
              <RcButton
                ...
                :data-testid="`rancher-ai-chat-chat-history-chat-item-${ index }`"
              ...
              >
                <input
                  ...
                  data-testid="rancher-ai-chat-chat-history-item-name-input"
                ...
                <span
                  ...
                  data-testid="rancher-ai-chat-chat-history-item-name"
