...
<template>
  <div
    ref="messagesView"
    class="chat-messages"
    data-testid="rancher-ai-chat-chat-messages"
  >
    <template
    ...
    >
      <component
        ...
        :data-testid="`rancher-ai-chat-chat-message-box-${ message.id }`"
        :data-teststatus="`rancher-ai-chat-chat-message-status-${ message.id }-${ message.completed ? 'completed' : 'inprogress' }`"
    ...
    <MessageComponent
      ...
      :data-testid="`rancher-ai-chat-chat-system-error-message-box-${ i + 1 }`"
      :message="error"
      :disabled="false"
    />
    <Processing
