...
<template>
  <div class="chat-source-container">
    <div class="chat-msg-source-label">
      <span>{{ t('aiChat.message.source.label') }}</span>
      <i
        class="icon icon-sm"
        :class="{
    ...
    >
      ...
      >
        <span class="sr-only">{{ t('aiChat.generic.opensInNewTab') }}</span>
        <ContextTag
          :data-testid="`rancher-ai-chat-chat-message-source-link-${ index }`"
