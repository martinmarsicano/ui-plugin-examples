...
const label = computed(() => {
  return props.tool.input.label || t(`aiChat.tools.${ props.tool.toolName }.name`, {}, true) || props.tool.toolName;
});
...
<template>
  ...
  <div v-else-if="route">
    <RcButton
      ...
      small
      tertiary
      :data-testid="`rancher-ai-chat-tool-explore-${ props.tool.input.route }`"
